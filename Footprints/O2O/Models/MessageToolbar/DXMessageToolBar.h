...
#define kBtnIconWidth   40
#define kBtnIconHeight   30
#define kInputTextViewBottomInset 8
#define kInputTextViewMinHeight 39
#define kInputTextViewMaxHeight 120
#define kHorizontalPadding 3
#define kVerticalPadding 5
#define kRealInputMinHeight (kInputTextViewMinHeight-kInputTextViewBottomInset)
...
- (void)didSendVoice:(NSData *)voice;
