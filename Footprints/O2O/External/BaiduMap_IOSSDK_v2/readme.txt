百度地图iOS SDK v2.7.0 Sample共有18个Demo,每个Demo的说明如下：
...
简介：介绍公交、驾车和步行三种路径规划方法和驾车途经点路径规划方法
详述：
...
（4）目前暂时开放了“POI搜索结果分享”和“反向地理编码结果分享”；
...
十七、
Demo名称：调启百度导航功能
文件名：NavigationDemoViewController.mm

简介：介绍如何通过API接口调启百度地图导航（百度地图客户端导航/百度地图Web端导航）
详述：
根据给定的起点、终点，通过调用API接口，打开百度地图导航，解决用户的导航需求。
-------------------------------------------------------------------------------------
十八、
Demo名称：OpenGL绘制功能
