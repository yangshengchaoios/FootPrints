...
#define DEFAULT_BUCKET @"tiangou-app-img"
/**
 *	@brief	默认表单API功能密钥 （必填项），可在init之后修改passcode的值来更改
 */
#define DEFAULT_PASSCODE @"lVBfg35QWT+r/LMFsoJjiQ5deno="
...
/* UPYUN
 ############################################图片上传路径######################################
 #图片空间命名
 PIC_BUCKET_NAME=tiangou-app-img
 #操作用户
 PIC_USER_NAME=tiangouapp
 #用户密码
 PIC_USER_PWD=tg123456
 ######上传目录前缀    正式环境为：tg8/upload  开始测试环境为：tg8/test/upload
 PIC_UPLOAD =test/upload
 */
