...
{
    NSInteger newIndex = index+[self.delegate sectionIndexOffsetForABELTableView:self];
    if ([self.tableView numberOfSections] > newIndex && newIndex > -1){   // for safety, should always be YES
        [self.tableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:newIndex]
